...
<div class="flex-wrap pt-3 pb-2 mb-3 d-flex justify-content-between flex-md-nowrap align-items-center border-bottom">
    <h1 class="h2">Cetak Laporan Penjualan</h1>
</div>
...
<div class="col-lg-8">
        ...
        <a href="" onclick="this.href='booking/cetak-data-pertanggal/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value " target="_blank" class="mb-3 btn btn-success">Preview Laporan</a>

        <a href="" onclick="this.href='booking/downloadPDF/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value " target="_blank" class="mb-3 btn btn-success">Download PDF</a>
