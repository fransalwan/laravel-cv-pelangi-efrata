...
<div class="border" style="margin-bottom: 10px;">
      ...
      <p class="text-end" style="font-size: 20px; padding:10px;">Laporan Penjualan</p>
</div>
  ...
  <table class="table border" id="table">
        ...
        <tbody class="text-center border">
            ...
            <tr class="text-center border">
              ...
              <td class="border">{{ $book->pelanggan->name }}</td> 
              <td class="border">{{ $book->name }}</td>
              <td class="border">{{ $book->harga_satuan }}</td>
              <td class="border">{{ $book->jumlah }}</td>
